    ...
    <ScreenWrapper>
      ...
      <View className="md:flex md:flex-row md:justify-between px-4">
        ...
        <View className=" flex-col items-center">
            ...
            <Image source={logoUrl} resizeMode="cover" className="h-20 w-20 md:h-7 md:w-7" />
            <Text className="text-3xl font-bold text-blue-600  text-center">TRADEZ</Text>
            </Pressable>

        </View>
        {/* bouton pour aller a la page de connexion */}
        <View className="flex-row gap-4 items-baseline justify-start">
          <Button
            title="Sign In"
      ...
      <View className="px-4  mt-4 flex flex-col items-center">
        <Image source={bannerUrl} className="w-[300px] h-[200px] object-cover" />
        <View>
            <Text className="text-2xl font-medium text-center text-slate-600">Tradez is a trading web application, which is good, save, secure and more.</Text>
        </View>
